...
SRC = Path(r"C:\Users\leegu\OneDrive\QTProject")
DST = Path(r"C:\Users\leegu\PycharmProjects\QuantitativeTrading")
...
if __name__ == "__main__":
    ans = input("確認要從OneDrive把檔案搬下來蓋過本機程式嗎？(Y/N): ").strip().upper()
