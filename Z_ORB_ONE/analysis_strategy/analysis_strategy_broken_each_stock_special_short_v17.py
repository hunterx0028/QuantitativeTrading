...
IX0043_STRATEGY_DECISION_REBOUND_PERCENT_LOWER = 0.2 # IX0043 反彈失效門檻：跌破後 high 不可回到前日最後 close 下方此百分比內
...
IX0043_STRATEGY_DECISION_DECLINE_PERCENT_FOLLOW = 0.2 # IX0043 回跌失效門檻：突破後 low 不可回到前日最後 close 上方此百分比內
